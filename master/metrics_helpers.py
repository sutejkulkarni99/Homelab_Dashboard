"""Metrics helpers."""
import http.client, json, os, socket, threading, time, urllib.request, urllib.error

# Config constants (from server.py header)
...
SERVICES = [
    ...
    {"id":"immich","cat":"Media & Storage","name":"Immich","url":"http://100.116.47.43:3000","desc":"Photo Backup","icon":"📸"},
    ...
    {"id":"vscode","cat":"AI & Dev Studio","name":"VS Code","url":"http://100.116.47.43:8443/?workspace=/config/workspace/polaris.code-workspace","desc":"Browser IDE","icon":"💻"},
    {"id":"jupyter","cat":"AI & Dev Studio","name":"Jupyter Lab","url":"http://100.116.47.43:8888/lab/tree/work","desc":"Data Notebooks","icon":"🪐"},
